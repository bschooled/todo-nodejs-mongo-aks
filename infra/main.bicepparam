...
param systemPoolSize = readEnvironmentVariable('AZURE_SYSTEM_POOL_SIZE','CostOptimised')
param agentPoolSize = readEnvironmentVariable('AZURE_AGENT_POOL_SIZE','CostOptimised')
